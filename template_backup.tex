...
在正文开始之前\cite{ran1996modeling},需要定义\verb|\cntitle|来定义中文标题,用\verb|\cnauthor|来定义中文作者,用\verb|\cnaddress|来定义中文地址,
...
\bibliographystyle{unsrt}  % 或者改为 gbt7714-2005 等国内常用格式
\bibliography{refs}        % 假设你的 BibTeX 文件叫 refs.bib
